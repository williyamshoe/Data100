...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Using version already downloaded: Mon Sep 17 23:39:39 2018
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Modify holiday weekday, workingday, and weathersit here}
        ...
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{holiday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{holiday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{no}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{yes}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{no}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{yes}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weekday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weekday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sun}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Mon}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Tue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Wed}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Thu}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Fri}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sat}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weathersit}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weathersit}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Clear}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Mist}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Light}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Heavy}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{bike}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:}    instant      dteday  season  yr  mnth  hr holiday weekday workingday  \textbackslash{}
...
\texttt{num\_holidays} to this value.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{num\PYZus{}holidays} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{holiday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{yes}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
         \PY{n}{num\PYZus{}holidays}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} 500
\end{Verbatim}
...
\texttt{\textquotesingle{}last\textquotesingle{}} aggregation functions.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{daily\PYZus{}counts} \PY{o}{=} \PY{n}{bike}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dteday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dteday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{agg}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sum}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sum}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{first}\PY{l+s+s2}{\PYZdq{}}\PY{p}{\PYZcb{}}\PY{p}{)}
         \PY{n}{daily\PYZus{}counts}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:}             casual  registered workingday
         dteday                                   
...
anywher from almost none to 7000.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{rcbikeplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{rcbikeplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{green}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{rcbikeplot}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{n}{xlabel}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rider Count}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ylabel}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Density}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distribution Comparison of Casual vs Registered Riders}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{rcbikeplot}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:} <matplotlib.legend.Legend at 0x7fa8d0ccaeb8>
\end{Verbatim}
...
comment on the spread of the distributions.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{n}{q2b} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{The casual rider histogram is very skewed to the right, and is bimodal. Both of its }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{modes(one at \PYZti{}100 and the other at \PYZti{}400), however, are very near zero. There is a slight }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{bump near the tail end of it, but nevertheless, the casual distribution is very centered }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{near/close to zero. However, there is a more spread of data for registered bikers. The }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered distribution is unimodal, with its mode at around 4000. The distribution is }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{fairly spread out and symmetric, with no outstanding gaps or outliers.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q2b}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}44}]:} 'The casual rider histogram is very skewed to the right, and is bimodal. Both of its modes(one at \textasciitilde{}100 and the other at \textasciitilde{}400), however, are very near zero. There is a slight bump near the tail end of it, but nevertheless, the casual distribution is very centered near/close to zero. However, there is a more spread of data for registered bikers. The registered distribution is unimodal, with its mode at around 4000. The distribution is fairly spread out and symmetric, with no outstanding gaps or outliers.'
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Make the font size a bit bigger}
         ...
         \PY{n}{rclplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lmplot}\PY{p}{(}\PY{n}{data}\PY{o}{=}\PY{n}{bike}\PY{p}{,} \PY{n}{x} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{hue} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{legend\PYZus{}out}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{scatter\PYZus{}kws}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}
...
\href{http://www.textbook.ds100.org/ch/06/viz_principles_2.html}{textbook}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{n}{q2d} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{There is a much higher casual to registered biker ratio on the weekends, when }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{compared to the weekdays. The overplotting may be an issue, since we can}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{t really }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{see the individual points within the mess of color near (0, 0). Thus, it is easy }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{to mistake how many data points there actually are in due to overplotting.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q2d}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}43}]:} "There is a much higher casual to registered biker ratio on the weekends, when compared to the weekdays. The overplotting may be an issue, since we can't really see the individual points within the mess of color near (0, 0). Thus, it is easy to mistake how many data points there actually are in due to overplotting."
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{patches} \PY{k}{as} \PY{n+nn}{mpatches}  \PY{c+c1}{\PYZsh{} see the tutorial for how we use mpatches to generate this figure!}
         ...
         \PY{n}{is\PYZus{}workingday} \PY{o}{=} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{workingday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{yes}\PY{l+s+s2}{\PYZdq{}}
         ...
         \PY{n}{casual\PYZus{}weekday} \PY{o}{=} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{n}{is\PYZus{}workingday}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
         \PY{n}{registered\PYZus{}weekday} \PY{o}{=} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{n}{is\PYZus{}workingday}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
         ...
         \PY{n}{casual\PYZus{}weekend} \PY{o}{=} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{is\PYZus{}workingday}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
         \PY{n}{registered\PYZus{}weekend} \PY{o}{=} \PY{n}{daily\PYZus{}counts}\PY{p}{[}\PY{o}{\PYZti{}}\PY{n}{is\PYZus{}workingday}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{} Use sns.kdeplot on the two variables above to plot the bivariate KDE for weekday rides}
         \PY{n}{weekdayplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{kdeplot}\PY{p}{(}\PY{n}{casual\PYZus{}weekday}\PY{p}{,} \PY{n}{registered\PYZus{}weekday}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Reds}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{weekendplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{kdeplot}\PY{p}{(}\PY{n}{casual\PYZus{}weekend}\PY{p}{,} \PY{n}{registered\PYZus{}weekend}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Blues}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} <matplotlib.legend.Legend at 0x7fa8d017a240>
\end{Verbatim}
...
plot you created for 2c? Why?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{q3b} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{There is a much higher casual to registered biker ratio on the weekends, when }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{compared to the weekdays. However, now we can see the distributions of each plot, }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{avoiding the dangers of overplotting. Because of this, this countour plot is }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{far better than the plot from 2c.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q3b}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}42}]:} 'There is a much higher casual to registered biker ratio on the weekends, when compared to the weekdays. However, now we can see the distributions of each plot, avoiding the dangers of overplotting. Because of this, this countour plot is far better than the plot from 2c.'
\end{Verbatim}
...
if your title overlaps with your plot
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{weekdayplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{jointplot}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{daily\PYZus{}counts}\PY{p}{,} \PY{n}{kind}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kde}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\texttt{sns.lineplot}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dteday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{str}\PY{p}{[}\PY{l+m+mi}{8}\PY{p}{:}\PY{p}{]}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{n+nb}{int}\PY{p}{)}
         \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{month}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dteday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{str}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{:}\PY{l+m+mi}{7}\PY{p}{]}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{n+nb}{int}\PY{p}{)}
         \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{year}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dteday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{str}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{4}\PY{p}{]}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{n+nb}{int}\PY{p}{)}
         \PY{n}{junebike} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{month}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{6}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{year}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{2011}\PY{p}{)}\PY{p}{]}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}
         \PY{n}{juneplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{junebike}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{juneplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{junebike}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{juneplot}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{n}{xlabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Day of the Month}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{ylabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of Riders}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{title} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Count of Casual vs Registered Riders by Day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{juneplot}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:} <matplotlib.legend.Legend at 0x7fa8ca3f0eb8>
\end{Verbatim}
...
average, wider than the confidence interval for casual riders?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{q4b} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{An interesting trend is that the casual bikers have a rather rymithic cycle of spiking }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{on weekends, then dipping on weekdays. However, the registered riders are the opposite: }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{they dip on the weekends and peak on the weekdays. However, no matter the day, there }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{always seems to be more registered riders than casual riders. The confidence interval }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{for registered bikers is much larger than that of the causal riders because registered }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{riders seem to have much more variance in their attendence than casual riders, who seem }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{to ride on a consistent schedule.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q4b}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
Your plot should look like the following:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{allbike} \PY{o}{=} \PY{n}{bike}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hr}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hr}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{as\PYZus{}index}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
         \PY{n}{allplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hr}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{allbike}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{allplot} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hr}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{allbike}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{allplot}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{n}{xlabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Hour of the Day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{ylabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of Riders}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{title} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Count of Casual vs Registered Riders by Hour}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{allplot}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}24}]:} <matplotlib.legend.Legend at 0x7fa8ca3dbe10>
\end{Verbatim}
...
peaks in the registered riders' distribution.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{q5b} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For the casual rider, they typically go biking later in the morning to the evening, in a }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{rather smooth curve. The registered bikers, however, have 2 massive peaks at around 8 am }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{and 5 pm. I suspect that there may be a biking club/team/organization that bike together }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{around this time, explaining the large spike of registered bikers at those specific times.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q5b}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}38}]:} 'For the casual rider, they typically go biking later in the morning to the evening, in a rather smooth curve. The registered bikers, however, have 2 massive peaks at around 8 am and 5 pm. I suspect that there may be a biking club/team/organization that bike together around this time, explaining the large spike of registered bikers at those specific times.'
\end{Verbatim}
...
representing the proportion of casual riders out of all riders.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{prop\PYZus{}casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{/}\PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cnt}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
...
{\color{incolor}In [{\color{incolor}31}]:} \PY{k+kn}{from} \PY{n+nn}{statsmodels}\PY{n+nn}{.}\PY{n+nn}{nonparametric}\PY{n+nn}{.}\PY{n+nn}{smoothers\PYZus{}lowess} \PY{k}{import} \PY{n}{lowess}
         ...
         \PY{k}{for} \PY{n}{d} \PY{o+ow}{in} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sat}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sun}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Mon}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Tue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Wed}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Thu}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Fri}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{:}
             \PY{n}{dowbike} \PY{o}{=} \PY{n}{bike}\PY{p}{[}\PY{n}{bike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weekday}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{n}{d}\PY{p}{]}
             \PY{n}{tempa} \PY{o}{=} \PY{n}{dowbike}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{temp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{41}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{9}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{32}
             \PY{n}{ysmooth} \PY{o}{=} \PY{n}{lowess}\PY{p}{(}\PY{n}{dowbike}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{prop\PYZus{}casual}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{tempa}\PY{p}{,} \PY{n}{return\PYZus{}sorted}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
             \PY{n}{tempcasual}\PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{lineplot}\PY{p}{(}\PY{n}{tempa}\PY{p}{,} \PY{n}{ysmooth}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{n}{d}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
         \PY{n}{tempcasual}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{n}{xlabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Temperature (Fahrenheit)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{ylabel} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Casual Rider Proportion}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}31}]:} [Text(0,0.5,'Casual Rider Proportion'), Text(0.5,0,'Temperature (Fahrenheit)')]
\end{Verbatim}
    ...
    \begin{verbatim}
<matplotlib.figure.Figure at 0x7fa8ca291198>
    \end{verbatim}
...
interesting?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{n}{q6c} \PY{o}{=} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{As a general trend, as temperature increases, the proportion of casual riders increases almost }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{linearly. However, on the weekends (Saturday and Sunday), there seems to be a significantly }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}
                \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{higher slope and higher proportion of casual riders.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{q6c}
         \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
         \PY{c+c1}{\PYZsh{}raise NotImplementedError()}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}40}]:} 'As a general trend, as temperature increases, the proportion of casual riders increases almost \textbackslash{}n linearly. However, on the weekends (Saturday and Sunday), there seems to be a significantly higher slope and higher proportion of casual riders.'
\end{Verbatim}
